...
export default function LoginModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-md p-6 overflow-hidden glass-panel rounded-2xl border border-slate-800 shadow-2xl">
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-lime-400/80 shadow-lg shadow-lime-400/20 mx-auto mb-3 bg-slate-900">
          ...
          <p className="text-sm text-slate-400 mt-1">Access your MM Padel Academy member portal</p>
        </div>
