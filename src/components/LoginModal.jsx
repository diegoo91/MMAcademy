...
export default function LoginModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-50/80 dark:bg-slate-950/80 backdrop-blur-md animate-fadeIn">
      <div className="relative w-full max-w-md p-6 overflow-hidden glass-panel rounded-2xl border border-slate-200 dark:border-slate-800 shadow-2xl">
        ...
        <button
          ...
          className="absolute top-4 right-4 p-2 text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-200/60 dark:hover:bg-slate-800/60 rounded-full transition-colors"
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-lime-400/80 shadow-lg shadow-lime-400/20 mx-auto mb-3 bg-white dark:bg-slate-900">
            <img src="/images/logo.jpg" alt="MM Padel Academy Logo" className="w-full h-full object-cover" />
          </div>
          <h3 className="text-2xl font-bold font-heading text-slate-900 dark:text-white">Welcome Back</h3>
          <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">Access your MM Padel Academy member portal</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-50/90 dark:bg-slate-900/90 border border-slate-300/80 dark:border-slate-700/80 text-slate-900 dark:text-white placeholder-slate-500 focus:outline-none focus:border-lime-400 focus:ring-1 focus:ring-lime-400 text-sm transition-all"
              />
            </div>
          </div>
