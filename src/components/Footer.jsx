  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-800 text-slate-400 pt-16 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-12 border-b border-slate-900">
          <div className="space-y-4">
            <Link to="/" className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-lime-400/80 shadow-lg shadow-lime-400/20 bg-slate-900 shrink-0">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              <a
                ...
                className="w-9 h-9 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center text-slate-400 hover:text-lime-400 hover:border-lime-400/50 transition-colors"
          ...
          <div>
            <h4 className="font-heading text-white font-bold text-base mb-4 uppercase tracking-wider">
              Quick Links
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-3.5 text-sm">
              <li className="flex items-start gap-3">
                ...
                <span className="text-slate-300 leading-snug">{CONTACT.address}</span>
              </li>
              <li className="flex items-center gap-3">
                <Phone className="w-4 h-4 text-lime-400 shrink-0" />
                <a href={CONTACT.phoneHref} className="hover:text-lime-400 transition-colors font-bold text-white">
                  {CONTACT.phone}
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <div>
                  <span className="text-white font-bold block">{CONTACT.hours}</span>
                  <span className="text-xs text-slate-500">Weekly Academy Schedule</span>
                </div>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="relative rounded-2xl overflow-hidden border border-slate-800 bg-slate-900 group">
              <img
                ...
                alt="Map preview"
                className="w-full h-32 object-cover opacity-60 group-hover:scale-105 transition-transform duration-500 bg-slate-900"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/40 to-transparent flex flex-col justify-end p-3 space-y-1">
        ...
        <div className="mt-8 pt-4 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500 gap-4">
