...
export default function Login() {
  ...
  if (user) {
    return (
      <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
        <div className="max-w-md w-full glass-panel rounded-3xl p-8 text-center border border-slate-800 shadow-2xl animate-fadeIn">
          ...
          <h1 className="font-heading text-3xl font-extrabold text-white mb-2">Welcome back, {user.name}!</h1>
          <p className="text-slate-400 text-sm mb-6">You are signed in as {user.email}.</p>
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 py-12 px-4 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        <div className="text-center mb-8">
          <div className="w-16 h-16 rounded-full overflow-hidden border-2 border-lime-400/80 shadow-lg shadow-lime-400/20 mx-auto mb-4 bg-slate-900">
            <img src="/images/logo.jpg" alt="MM Padel Academy Logo" className="w-full h-full object-cover" />
          </div>
          <h1 className="font-heading text-3xl font-black text-white">Member Login</h1>
          <p className="text-slate-400 text-sm mt-1">Access your MM Padel Academy portal</p>
        </div>
        ...
        <div className="glass-panel rounded-3xl p-6 sm:p-8 border border-slate-800 shadow-2xl">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl bg-slate-900/90 border border-slate-700/80 text-white placeholder-slate-500 focus:outline-none focus:border-lime-400 focus:ring-1 focus:ring-lime-400 text-sm transition-all"
                />
              </div>
            </div>
            <div>
          ...
          <div className="mt-4 flex items-center gap-2 p-3 rounded-xl bg-lime-400/5 border border-lime-400/20 text-xs text-slate-400">
