...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-slate-900/90 border border-lime-400/40 text-lime-400 text-xs font-extrabold uppercase tracking-widest shadow-lg shadow-lime-400/10">
                <Flame className="w-4 h-4 fill-lime-400 text-lime-400 animate-pulse" />
                <span>Train • Improve • Compete</span>
              </div>

              <h1 className="font-heading text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight tracking-tight">
              ...
              <p className="text-lg sm:text-xl text-slate-300 max-w-2xl font-normal leading-relaxed mx-auto lg:mx-0">
                Professional padel coaching across our 2 dedicated courts — private coaching and group
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-4">
                ...
                <Link
                  to="/signup"
                  className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-slate-900/90 hover:bg-slate-800 text-white font-extrabold text-base border border-slate-700 transition-all flex items-center justify-center gap-3 hover:border-lime-400/50"
                >
              ...
              <div className="pt-6 flex flex-wrap items-center justify-center lg:justify-start gap-x-6 gap-y-2 text-xs text-slate-400 font-medium">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-lime-400" />
                  <span>Sun – Thu (3 PM – 11 PM)</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-lime-400" />
            ...
            <div className="lg:col-span-5 relative">
              <div className="relative rounded-3xl overflow-hidden border border-slate-800 shadow-2xl group bg-slate-900">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl glass-panel border border-slate-700/60 flex items-center justify-between">
                  <div>
                    <span className="text-xs font-bold text-lime-400 uppercase tracking-wider">
                      Private &amp; Group Packages
                    </span>
                    <p className="text-white font-extrabold text-sm mt-0.5">From 500 EGP / session</p>
                  </div>
                  <Link
                    to="/book"
            ...
            {ACADEMY_STATS.map((stat, idx) => {
              ...
              return (
                <div key={idx} className="p-6 rounded-2xl glass-card text-center flex flex-col items-center justify-center">
                  ...
                  <div className="font-heading text-3xl font-black text-white">{stat.value}</div>
      ...
      <section className="py-20 bg-slate-900/40 relative border-b border-slate-800/60">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-6">
              ...
              <p className="text-slate-300 text-base leading-relaxed">
                ...
                <strong>Sunday to Thursday (3:00 PM – 11:00 PM)</strong>.
              </p>

              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-3">
                  <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                    <h4 className="font-heading font-extrabold text-white text-base">Private Coaching</h4>
                  ...
                  <ul className="space-y-2 text-xs">
                    <li className="flex justify-between text-slate-300">
                      <span>1 Session:</span>
                      <strong className="text-white">1,000 EGP</strong>
                    </li>
                    <li className="flex justify-between text-slate-300">
                ...
                <div className="p-5 rounded-2xl bg-slate-900/90 border border-slate-800 space-y-3">
                  <div className="flex justify-between items-center border-b border-slate-800 pb-2">
                    <h4 className="font-heading font-extrabold text-white text-base">Group Class</h4>
                    <span className="text-[10px] font-bold px-2 py-0.5 rounded bg-purple-500/20 text-purple-300">Clinics</span>
                  </div>
                  <ul className="space-y-2 text-xs">
                    <li className="flex justify-between text-slate-300">
                      <span>1 Session:</span>
                      <strong className="text-white">500 EGP</strong>
                    </li>
                    <li className="flex justify-between text-slate-300">
                      <span>4 Sessions:</span>
      ...
      {/* 3. PROGRAMS */}
      <section id="coaches" className="py-20 relative border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
            ...
            <p className="text-slate-400 text-base">
              Private coaching or group classes — pick the path that fits your game.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            {PROGRAMS.map((program) => (
              <div key={program.id} className="glass-card rounded-2xl overflow-hidden flex flex-col justify-between group bg-slate-900/60">
                <div>
                  ...
                  <div className="p-5 space-y-3">
                    <h3 className="font-heading font-extrabold text-lg text-white group-hover:text-lime-400 transition-colors">
                      {program.title}
                    </h3>
                    <p className="text-xs text-slate-400 line-clamp-2 leading-relaxed">{program.description}</p>

                    <div className="p-2.5 rounded-xl bg-slate-950/80 border border-slate-800 text-[11px] text-lime-400 font-semibold">
                      {program.packages}
                    </div>
                ...
                <div className="p-5 pt-0">
                  <Link
                    to="/book"
                    className="w-full py-2.5 rounded-xl bg-slate-900 hover:bg-lime-400 hover:text-slate-950 text-white font-bold text-xs transition-all border border-slate-700 hover:border-lime-400 flex items-center justify-center gap-2"
                  >
      ...
      {/* 4. GALLERY */}
      <section id="gallery" className="py-20 bg-slate-900/30 border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredGallery.map((item) => (
              <div key={item.id} className="relative rounded-2xl overflow-hidden h-72 border border-slate-800 group bg-slate-900">
                <img
                  src={item.image}
                  alt={item.title}
      ...
      {/* 5. TESTIMONIALS */}
      <section className="py-20 relative border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto space-y-3 mb-14">
            <span className="text-xs font-extrabold uppercase tracking-widest text-lime-400">
              Community Testimonials
            </span>
            <h2 className="font-heading text-3xl font-extrabold text-white">Loved by Players of All Levels</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTIMONIALS.map((t) => (
              <div key={t.id} className="glass-card rounded-2xl p-6 space-y-4 relative bg-slate-900/60">
                ...
                <div className="flex items-center gap-3 pt-3 border-t border-slate-800">
                  <img src={t.avatar} alt={t.name} className="w-10 h-10 rounded-full object-cover border border-slate-700 bg-slate-800" />
                  <div>
      ...
      {/* 6. CONTACT (phone / hours / location — no email, per spec) */}
      <section className="py-20 bg-slate-900/40 border-b border-slate-800/60">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-2xl mx-auto space-y-3 mb-12">
            ...
            <h2 className="font-heading text-3xl font-extrabold text-white">Contact the Academy</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <a href={CONTACT.phoneHref} className="glass-card rounded-2xl p-6 flex items-start gap-4 hover:border-lime-400/40">
              ...
              <span>
                <span className="block text-xs uppercase tracking-wider text-slate-400 font-bold">Phone / WhatsApp</span>
                <span className="block text-white font-extrabold mt-1">{CONTACT.phone}</span>
              </span>
            </a>
            <div className="glass-card rounded-2xl p-6 flex items-start gap-4">
              ...
              <span>
                <span className="block text-xs uppercase tracking-wider text-slate-400 font-bold">Hours</span>
                <span className="block text-white font-extrabold mt-1">{CONTACT.hours}</span>
              </span>
            </div>
            <a href={mapsUrl} target="_blank" rel="noreferrer" className="glass-card rounded-2xl p-6 flex items-start gap-4 hover:border-lime-400/40">
              ...
              <span>
                <span className="block text-xs uppercase tracking-wider text-slate-400 font-bold">Location</span>
                <span className="block text-slate-200 text-sm mt-1 leading-relaxed">{CONTACT.address}</span>
                <span className="block text-lime-400 text-xs font-bold mt-2">Open in Google Maps →</span>
              </span>
            </a>
          </div>
        </div>
      ...
      {/* CTA */}
      <section className="py-16 bg-gradient-to-r from-lime-500/20 via-emerald-500/10 to-slate-900 border-t border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-6">
          <h2 className="font-heading text-3xl sm:text-4xl font-extrabold text-white">Ready to Step Onto the Court?</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-2">
            ...
            <Link
              to="/signup"
              className="px-8 py-3.5 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-sm border border-slate-700 transition-all"
            >
